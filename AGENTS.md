...
- `python -m src.contact_loss_recovery_matrix --config configs/contact_loss_recovery_matrix.yaml --output <path>` runs the fixed-seed MuJoCo recovery matrix and retains failures.

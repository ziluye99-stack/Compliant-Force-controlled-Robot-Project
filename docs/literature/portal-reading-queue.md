...
| P1 | Chinese neural admittance | *Neural Network Adaptive Force Tracking Admittance Control for Spinning Yarn Piecing Robot* | Journal of Mechanical Engineering, 2023; DOI `10.3901/jme.2023.11.221`; CNKI/万方 record and PDF required | Metadata candidate from public probe; verify portal version |
...
| P1 | Multi-contact arm impedance | *Multi-Contact Cartesian Null-Space Impedance Control for the Anthropomorphic Manipulator Without Knowledge of Force Locations* | IEEE RA-L, 2024; DOI `10.1109/LRA.2024.3443639`; [publisher DOI](https://doi.org/10.1109/LRA.2024.3443639) | Discovery candidate; verify contact assumptions, force sensing, and limits |
| P1 | Vision-based force sensing | *A soft thumb-sized vision-based sensor with accurate all-round force perception* | Nature Machine Intelligence, 2022; DOI `10.1038/s42256-021-00439-3`; [publisher DOI](https://doi.org/10.1038/s42256-021-00439-3) | Discovery candidate; verify calibration, bandwidth, and manipulation metrics |
| P1 | Multimodal tactile manipulation | *Multimodal tactile sensing fused with vision for dexterous robotic housekeeping* | Nature Communications, 2024; DOI `10.1038/s41467-024-51261-5`; [publisher DOI](https://doi.org/10.1038/s41467-024-51261-5) | Discovery candidate; verify sensor fusion and contact-task evaluation |
| P1 | Adaptive compliant hand control | *Multifingered Robot Hand Compliant Manipulation Based on Vision-Based Demonstration and Adaptive Force Control* | IEEE T-NNLS, 2022; DOI `10.1109/TNNLS.2022.3184258`; [publisher DOI](https://doi.org/10.1109/TNNLS.2022.3184258) | Discovery candidate; verify learning protocol, baselines, and real-hardware evidence |
| P1 | Contact-safe learning | *Stability-Guaranteed Reinforcement Learning for Contact-Rich Manipulation* | IEEE RA-L, 2021; DOI `10.1109/LRA.2020.3028529`; [publisher DOI](https://doi.org/10.1109/LRA.2020.3028529) | New metadata candidate; verify stability certificate, contact assumptions, and force/safety metrics |
| P1 | Contact-safe learning | *A Contact-Safe Reinforcement Learning Framework for Contact-Rich Robot Manipulation* | IROS, 2022; DOI `10.1109/IROS.2022.9981185`; [publisher DOI](https://doi.org/10.1109/IROS.2022.9981185) | New metadata candidate; verify constraint implementation and held-out evaluation |
| P1 | Whole-body contact learning | *Learning contact-rich whole-body manipulation with example-guided reinforcement learning* | Science Robotics, 2025; DOI `10.1126/scirobotics.ads6790`; [publisher DOI](https://doi.org/10.1126/scirobotics.ads6790) | New metadata candidate; verify humanoid/whole-body setup, demonstrations, and contact metrics |
| P1 | Humanoid distributed tactile control | *Whole-Body Multi-Contact Motion Control for Humanoid Robots Based on Distributed Tactile Sensors* | IEEE RA-L, 2024; DOI `10.1109/LRA.2024.3475052`; [publisher DOI](https://doi.org/10.1109/LRA.2024.3475052) | New metadata candidate; verify final version, tactile calibration, contact switching, and force metrics |
| P1 | Humanoid force feasibility | *Multi-Contact Whole-Body Force Control for Position-Controlled Robots* | IEEE RA-L, 2024; DOI `10.1109/LRA.2024.3396094`; [publisher DOI](https://doi.org/10.1109/LRA.2024.3396094) | New metadata candidate; verify wrench feasibility, position-control assumptions, and robustness tests |
| P1 | Compliant assembly | *Variable Compliance Control for Robotic Peg-in-Hole Assembly: A Deep-Reinforcement-Learning Approach* | Applied Sciences, 2020; DOI `10.3390/app10196923`; [publisher DOI](https://doi.org/10.3390/app10196923) | Open-access candidate; verify PDF provenance, baseline, and assembly force metrics |
